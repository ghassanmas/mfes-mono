...
export declare function synchronousBodyHandler(handler: (body: any) => any): MessageConsumer;
export declare function asynchronousBodyHandler(handler: (body: any) => Promise<any>): MessageConsumer;
