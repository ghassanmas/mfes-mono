...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--prefix' '/tmp/ruby' '--disable-install-doc' '--disable-install-rdoc' '--disable-install-capi' '--without-ext=tk,sdbm,gdbm,dbm,dl,coverage' 'CFLAGS=-g -O2  -I/hbb_shlib/include ' 'LDFLAGS=-L/hbb_shlib/lib -static-libstdc++' 'CPPFLAGS=-I/hbb_shlib/include' 'CXXFLAGS=-g -O2  -I/hbb_shlib/include '"
  ...
  CONFIG["LDFLAGS"] = "-L. -L/hbb_shlib/lib -static-libstdc++ -fstack-protector -rdynamic -Wl,-export-dynamic"
