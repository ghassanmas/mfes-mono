...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<faraday_middleware>.freeze, ["<= 2.0", ">= 0.10"])
      ...
      s.add_dependency(%q<pact>.freeze, ["~> 1.59"])
      s.add_dependency(%q<pact-message>.freeze, ["~> 0.5"])
      s.add_dependency(%q<faraday>.freeze, ["<= 2.0", ">= 0.9.0"])
      s.add_dependency(%q<faraday_middleware>.freeze, ["<= 2.0", ">= 0.10"])
      ...
      s.add_dependency(%q<word_wrap>.freeze, [">= 0"])
    end
  else
    s.add_dependency(%q<rspec>.freeze, ["~> 3.5"])
    s.add_dependency(%q<pact>.freeze, ["~> 1.59"])
